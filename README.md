...
A shared web and Tauri GUI is being built in this repository so the app can
evolve alongside the Rust/WASM engine APIs it needs. The current plan and phase
status live in [`WEB_ROADMAP.md`](WEB_ROADMAP.md). The user-facing feature
roadmap is tracked in [`PRODUCT_ROADMAP.md`](PRODUCT_ROADMAP.md).
