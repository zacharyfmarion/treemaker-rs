...
| `FoldingServiceImpl.foldAnother` | Request another overlap solution. | `folding::commands::fold_another`, `folding::WorkerOverlapEnumerator` | 10 | Unsupported command; underlying stateful worker enumeration ported |
