...
## Goal
Add SVG and PNG export options so users can choose the crease-pattern view mode and whether unassigned creases are included, with a live preview before saving.
## Approach
