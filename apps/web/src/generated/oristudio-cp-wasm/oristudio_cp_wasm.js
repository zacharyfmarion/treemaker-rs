/* @ts-self-types="./oristudio_cp_wasm.d.ts" */

/**
 * @returns {any}
 */
export function cp_operation_descriptors() {
    const ret = wasm.cp_operation_descriptors();
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function document_snapshot(handle) {
    const ret = wasm.document_snapshot(handle);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function document_summary(handle) {
    const ret = wasm.document_summary(handle);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function export_cp(handle) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.export_cp(handle);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function export_fold(handle) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.export_fold(handle);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {number}
 */
export function load_document(document) {
    const ret = wasm.load_document(document);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
 ...
 * @returns {number}
 */
export function load_fold(text, title) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(title, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./oristudio_cp_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('oristudio_cp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
