...
| `origami/folding/element/SubFace.java` | Subface data and overlap relations. | `folding::SubFace`, `folding::SubFacePermutationSearch` | kernel | 10 | Porting; membership/reduction and guide-map oracle |
